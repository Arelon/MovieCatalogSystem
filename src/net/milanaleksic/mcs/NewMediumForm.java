...
public class NewMediumForm {
	...
	private static Logger log = Logger.getLogger(NewMediumForm.class); // @jve:decl-index=0:
	...
	private void createSShell() {
		...
		label2 = new Label(sShell, SWT.LEFT);
	...
	private void createGroup() {
		...
		rbDVD = new Button(group, SWT.RADIO);
		rbDVD.setText("DVD");
