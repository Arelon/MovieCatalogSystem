...
public class RestorePointCreator {
    ...
    @Language("SQL") private static final String CREATE_SCRIPT_DB2_ONLY_HEADER =
    ...
    @Language("SQL") private static final String RESTORE_SCRIPT_DB2_ONLY_HEADER =
		"CONNECT TO KATALOG USER DB2ADMIN USING db2admin";

    @Language("SQL") private static final String RESTORE_SCRIPT_HEADER =
		"set schema DB2ADMIN;\r\n" +
		"\r\n";

    @Language("SQL") private static final String CREATE_SCRIPT_PRE_1_LOGER =
    ...
    @Language("SQL") private static final String CREATE_SCRIPT_PRE_2_LOGER_AKCIJA =
    ...
    @Language("SQL") private static final String CREATE_SCRIPT_PRE_3_FILM =
		", INCREMENT BY 1) PRIMARY KEY,\r\n"+
    ...
    @Language("SQL") private static final String CREATE_SCRIPT_PRE_4_MEDIJ =
		", INCREMENT BY 1) PRIMARY KEY,\r\n"+
    ...
    @Language("SQL") private static final String CREATE_SCRIPT_PRE_5_POZICIJA =
		", INCREMENT BY 1) PRIMARY KEY,\r\n"+
		"    Indeks int NOT NULL,\r\n"+
		"    idTip int NOT NULL,\r\n"+
	...
	@Language("SQL") private static final String CREATE_SCRIPT_PRE_6_TIP_MEDIJA =
		", INCREMENT BY 1) PRIMARY KEY,\r\n"+
	...
	@Language("SQL") private static final String CREATE_SCRIPT_PRE_7_ZANR =
		", INCREMENT BY 1) PRIMARY KEY,\r\n"+
		"    Naziv varchar(100) NOT NULL\r\n"+
		")\r\n"+
		";\r\n"+
	...
	@Language("SQL") private static final String CREATE_SCRIPT_ENDING =
		", INCREMENT BY 1) PRIMARY KEY,\r\n"+
	...
	@Language("SQL") public static final String INDEX_CREATION = "DROP INDEX DB2ADMIN.IDX_FILM_NAZIVFILMA;\r\n"+
    ...
    private void compressPreviousRestoreFiles(File renamedOldRestoreFile) {
        ...
        try {
            ...
            if (zos != null) try {zos.close();} catch(Throwable ignored) {}
